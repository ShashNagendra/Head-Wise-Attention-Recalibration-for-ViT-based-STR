...
def get_args(is_train=True):
    ...
    choices = ["HTR_VT_16_heads_with_headSE", "HTR_VT_24_heads_with_headSE"]
    ...
    # In your config/options.py
    parser.add_argument('--TransformerMAE', action='store_true', help='Use MAE-enhanced ViTSTR')
    parser.add_argument('--mask_ratio', type=float, default=0.75, help='Masking ratio for MAE')
    parser.add_argument('--use_masking', action='store_true', help='Enable masking for MAE')
    parser.add_argument('--patchH', type=int, default=4, help='Patch height size')
    parser.add_argument('--patchW', type=int, default=64, help='Patch width size')
